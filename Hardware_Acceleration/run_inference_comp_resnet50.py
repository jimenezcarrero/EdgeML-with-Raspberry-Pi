#!/usr/bin/env python3
"""
ResNet50 Inference Comparison: CPU vs MemryX MX3 Accelerator

This script is similar to the MobileNetV2 version but uses ResNet50,
demonstrating performance improvements on larger models.
...
DFP_PATH = MODELS_DIR / "resnet50.dfp"
KERAS_PATH = MODELS_DIR / "resnet50.h5"
...
def load_and_preprocess_image(image_path):
    ...
    - Preprocessing: Mean subtraction in RGB channels
    - Color format: RGB
    ...
    # This subtracts the ImageNet mean from each channel
...
def main():
    ...
    print("=" * 70)
    print("ResNet50 Inference: CPU vs MemryX MX3 Comparison")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print("Note: ResNet50 shows even more dramatic speedups than MobileNetV2")
    print("because larger models benefit more from hardware acceleration.")
    print("=" * 70)
